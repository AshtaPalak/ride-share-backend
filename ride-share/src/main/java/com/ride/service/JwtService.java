...
public class JwtService {
    ...
    public String generateToken(com.ride.model.Customer customer) {
        return generateToken(new HashMap<>(), customer);
    }
 
    public String generateToken(Map<String, Object> extraClaims, com.ride.model.Customer customer) {
...
//    	extraClaims.put("role", userDetails.getRoles());
    ...
    private String buildToken(
            ...
            com.ride.model.Customer customer,
            long expiration
    ) {
        return Jwts
                .builder()
